var CompanyX = {
   getCalendar : function () {
       return CompanyX.ScheduleCalendarPanel;
   },
   
   getStore : function () {
       return CompanyX.ScheduleEventStore;
   },
   
   getWindow : function () {
       return CompanyX.ScheduleEventWindow;
   },
   ...
   viewChange : function (p, vw, dateInfo) {
        ...
        if (dateInfo) {
            ...
            this.ScheduleDatePicker.setValue(dateInfo.activeDate);
    ...
    updateTitle : function (startDt, endDt) {
        ...
        this.SchedulePanel.setTitle(msg);
    },
